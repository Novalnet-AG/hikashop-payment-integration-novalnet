<?php
/**
* This script is used for updating the Przelewy24 transaction details
*
* @author Novalnet AG
...
/**
 * Novalnet Przelewy24 payment class
 *
 * @package Hikashop_Payment_Plugin
 */
class PlgHikashoppaymentnovalnet_Przelewy24 extends hikashopPaymentPlugin
{
    /**
     ...
     * @var string
     */
    public $name = 'novalnet_przelewy24';
    var $pluginConfig = array(
		...
		'transactionBeforeStatus' 	=> array('HKPAYMENT_NOVALNET_PREZELEWY24_STATUS', 'orderstatus'),
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $lang->load('plg_hikashoppayment_novalnet_przelewy24', JPATH_ADMINISTRATOR);
    ...
    public function onAfterOrderConfirm(&$order, &$methods, $method_id)
    {
        ...
        // Prepares przelewy24 parameters for payment processing
        $this->vars = NovalnetUtilities::doFormPaymentParameters($this, $order);
        $this->vars['key'] = '78';
        $this->vars['payment_type'] = 'PRZELEWY24';
    ...
    {
        foreach (array('payment_name' => JText::_('HKPAYMENT_NOVALNET_PAYMENT_PRZELEWY24'), 'payment_description' => JText::_('HKPAYMENT_NOVALNET_REDIRECT_DESC'), 'payment_images' => 'novalnet_przelewy24') as $configKey => $configValue)
        {
            $element->$configKey = $configValue;
        }
        foreach (array('testmode' => false, 'payment_currency' => true, 'transactionEndStatus' => "confirmed", 'transaction_before_status' => "created") as $pluginKey => $pluginValue)
        {
