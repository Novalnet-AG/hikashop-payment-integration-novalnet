<?php
/**
* This script is used EPS payment
*
* @author Novalnet AG
...
/**
 * Novalnet eps payment class
 *
 * @package Hikashop_Payment_Plugin
 */
class PlgHikashoppaymentnovalnet_Eps extends hikashopPaymentPlugin
{
    /**
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $lang->load('plg_hikashoppayment_novalnet_eps', JPATH_ADMINISTRATOR);
    ...
    public function onAfterOrderConfirm(&$order, &$methods, $method_id)
    {
        ...
        // Prepares eps parameters for payment processing
        $this->vars = NovalnetUtilities::doFormPaymentParameters($this, $order);
        $this->vars['key'] = '50';
        $this->vars['payment_type'] = 'EPS';
    ...
    {
        foreach (array('payment_name' => JText::_('HKPAYMENT_NOVALNET_PAYMENT_EPS'), 'payment_description' => JText::_('HKPAYMENT_NOVALNET_REDIRECT_DESC'), 'payment_images' => 'novalnet_eps') as $configKey => $configValue)
        {
