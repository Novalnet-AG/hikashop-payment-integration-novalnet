...
/**
 * Instant Bank Transfer payment class
 *
 * @package Hikashop_Payment_Plugin
 */
class PlgHikashoppaymentnovalnet_Banktransfer extends hikashopPaymentPlugin
{
    /**
     ...
     * @var string
     */
    public $name = 'novalnet_banktransfer';
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $lang->load('plg_hikashoppayment_novalnet_banktransfer', JPATH_ADMINISTRATOR);
    ...
    public function onAfterOrderConfirm(&$order, &$methods, $method_id)
    {
        ...
        // Prepares Instant Bank Transfer parameters for payment processing
        $this->vars = NovalnetUtilities::doFormPaymentParameters($this, $order);
        $this->vars['key'] = '33';
        $this->vars['payment_type'] = 'ONLINE_TRANSFER';
    ...
    {
        foreach (array('payment_name' => JText::_('HKPAYMENT_NOVALNET_PAYMENT_BANKTRANSFER'), 'payment_description' => JText::_('HKPAYMENT_NOVALNET_REDIRECT_DESC'), 'payment_images' => 'novalnet_banktransfer') as $configKey => $configValue)
        {
