...
/**
 * Novalnet Giropay payment class
 *
 * @package Hikashop_Payment_Plugin
 */
class PlgHikashoppaymentnovalnet_Giropay extends hikashopPaymentPlugin
{
    /**
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $lang->load('plg_hikashoppayment_novalnet_giropay', JPATH_ADMINISTRATOR);
    ...
    public function onAfterOrderConfirm(&$order, &$methods, $method_id)
    {
        ...
        // Prepares giropay parameters for payment processing
        $this->vars = NovalnetUtilities::doFormPaymentParameters($this, $order);
        $this->vars['key'] = '69';
        $this->vars['payment_type'] = 'GIROPAY';
    ...
    {
        foreach (array('payment_name' => JText::_('HKPAYMENT_NOVALNET_PAYMENT_GIROPAY'), 'payment_description' => JText::_('HKPAYMENT_NOVALNET_REDIRECT_DESC'), 'payment_images' => 'novalnet_giropay') as $configKey => $configValue)
        {
